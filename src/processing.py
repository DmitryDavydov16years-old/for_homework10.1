def sorting_the_dictionary(list_of_dictionaries: list, value_for_key: str = "EXECUTED") -> list:
    ...
    for dictionary in list_of_dictionaries:
        if dictionary.get("state") == value_for_key:
...
gav = [{'id': 441945886, 'state': 'EXECUTED', 'date': '2019-08-26T10:50:58.294041',
       ...
       {'id': 142264268, 'state': 'EXECUTED', 'date': '2019-04-04T23:20:05.206878',
        ...
        'to': 'Счет 75651667383060284188'}, {'id': 873106923, 'state': 'EXECUTED', 'date': '2019-03-23T01:09:46.296404',
       ...
       {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689',
        ...
        'to': 'Счет 14211924144426031657'}, {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441',
       ...
       {'id': 147815167, 'state': 'EXECUTED', 'date': '2018-01-26T15:40:13.413061',
        ...
        'to': 'Счет 43597928997568165086'}, {'id': 518707726, 'state': 'EXECUTED', 'date': '2018-11-29T07:18:23.941293',
                                             'operationAmount': {'amount': '3348.98',
                                                                 'currency': {'name': 'USD', 'code': 'USD'}},
                                             'description': 'Перевод с карты на карту',
                                             'from': 'MasterCard 3152479541115065', 'to': 'Visa Gold 9447344650495960'},
       ...
       {'id': 542678139, 'state': 'EXECUTED', 'date': '2018-10-14T22:27:25.205631',
        ...
        'to': 'Счет 78808375133947439319'}, {'id': 558167602, 'state': 'EXECUTED', 'date': '2019-04-12T17:27:27.896421',
                                             'operationAmount': {'amount': '43861.89',
                                                                 'currency': {'name': 'USD', 'code': 'USD'}},
                                             'description': 'Перевод со счета на счет',
                                             'from': 'Счет 73654108430135874305', 'to': 'Счет 89685546118890842412'},
       ...
       {'id': 536723678, 'state': 'EXECUTED', 'date': '2018-06-12T07:17:01.311610',
        ...
        'to': 'Счет 17066032701791012883'}, {'id': 172864002, 'state': 'EXECUTED', 'date': '2018-12-28T23:10:35.459698',
       ...
       {'id': 988276204, 'state': 'EXECUTED', 'date': '2018-02-22T00:40:19.984219',
        ...
        'description': 'Перевод организации', 'from': 'MasterCard 4956649687637418', 'to': 'Счет 90562872508279542248'},
       {'id': 888407131, 'state': 'EXECUTED', 'date': '2019-09-29T14:25:28.588059',
        ...
        'to': 'Счет 46723050671868944961'}, {'id': 634356296, 'state': 'EXECUTED', 'date': '2018-01-21T01:10:28.317704',
                                             'operationAmount': {'amount': '96900.90',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод со счета на счет',
                                             'from': 'Счет 33407225454123927865', 'to': 'Счет 79619011266276091215'},
       {'id': 34148726, 'state': 'EXECUTED', 'date': '2018-11-23T23:52:36.999661',
        ...
        'to': 'Maestro 8045769817179061'}, {'id': 970724427, 'state': 'CANCELED', 'date': '2019-01-15T17:58:27.064377',
       ...
       {'id': 550607912, 'state': 'EXECUTED', 'date': '2018-07-31T12:25:32.579413',
        ...
        'description': 'Перевод организации', 'from': 'MasterCard 8532498887072395', 'to': 'Счет 44238164562083919420'},
       {'id': 608117766, 'state': 'CANCELED', 'date': '2018-10-08T09:05:05.282282',
        ...
        'to': 'Счет 38573816654581789611'}, {'id': 484201274, 'state': 'EXECUTED', 'date': '2019-04-11T23:10:21.514616',
       ...
       {'id': 811920303, 'state': 'EXECUTED', 'date': '2019-06-14T19:37:49.044089',
        ...
        'to': 'Счет 78544755774551298747'}, {'id': 509645757, 'state': 'EXECUTED', 'date': '2019-10-30T01:49:52.939296',
                                             'operationAmount': {'amount': '23036.03',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод с карты на счет',
                                             'from': 'Visa Gold 7756673469642839', 'to': 'Счет 48943806953649539453'},
       ...
       {'id': 743278119, 'state': 'EXECUTED', 'date': '2018-10-15T08:05:34.061711',
        ...
        'to': 'Maestro 7452400219469235'}, {'id': 871921546, 'state': 'EXECUTED', 'date': '2019-02-14T03:09:23.006652',
                                            'operationAmount': {'amount': '47022.09',
                                                                'currency': {'name': 'руб.', 'code': 'RUB'}},
                                            'description': 'Перевод организации',
                                            'from': 'Visa Classic 6216537926639975', 'to': 'Счет 67667879435628279708'},
       {'id': 373912477, 'state': 'EXECUTED', 'date': '2018-03-09T02:11:01.339352',
        ...
        'to': 'Счет 60979028617970883410'}, {'id': 720751477, 'state': 'EXECUTED', 'date': '2018-11-08T08:21:45.902633',
       ...
       {'id': 72122709, 'state': 'EXECUTED', 'date': '2018-12-18T17:07:09.800800',
        ...
        'to': 'Счет 15351391408911677994'}, {'id': 242885401, 'state': 'EXECUTED', 'date': '2019-07-08T00:08:32.986663',
                                             'operationAmount': {'amount': '10083.68',
                                                                 'currency': {'name': 'USD', 'code': 'USD'}},
                                             'description': 'Перевод со счета на счет',
                                             'from': 'Счет 38427597486442637521', 'to': 'Счет 83889757415570699323'},
       {'id': 286706711, 'state': 'EXECUTED', 'date': '2018-02-06T06:42:02.219233',
        'operationAmount': {'amount': '621.37', 'currency': {'name': 'руб.', 'code': 'RUB'}},
        'description': 'Перевод организации', 'from': 'MasterCard 9175985085449563', 'to': 'Счет 82781399328834147668'},
       ...
       {'id': 464419177, 'state': 'CANCELED', 'date': '2018-07-15T18:44:13.346362',
        ...
        'to': 'Счет 19213886662094884261'}, {'id': 560813069, 'state': 'CANCELED', 'date': '2019-12-03T04:27:03.427014',
       ...
       {'id': 894961746, 'state': 'EXECUTED', 'date': '2019-08-04T20:17:25.443322',
        ...
        'to': 'Счет 68774571780974952778'}, {'id': 360577236, 'state': 'EXECUTED', 'date': '2019-09-07T07:20:13.889610',
                                             'operationAmount': {'amount': '18536.73',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод с карты на карту',
                                             'from': 'Maestro 4284341727554246', 'to': 'МИР 1582474475547301'},
       ...
       {'id': 636137913, 'state': 'EXECUTED', 'date': '2019-06-16T22:17:01.825020',
        ...
        'to': 'Счет 15574304810835774010'}, {'id': 813238385, 'state': 'EXECUTED', 'date': '2018-05-04T03:29:30.253483',
                                             'operationAmount': {'amount': '22007.02',
                                                                 'currency': {'name': 'USD', 'code': 'USD'}},
                                             'description': 'Перевод с карты на счет',
                                             'from': 'MasterCard 3595832182277400', 'to': 'Счет 79697233246085035210'},
       {'id': 854048120, 'state': 'EXECUTED', 'date': '2019-03-29T10:57:20.635567',
        ...
        'to': 'Счет 34616199494072692721'}, {'id': 269462132, 'state': 'EXECUTED', 'date': '2018-08-14T05:42:30.104666',
                                             'operationAmount': {'amount': '19010.50',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод со счета на счет',
                                             'from': 'Счет 18125798580985711166', 'to': 'Счет 98841213648056852372'},
       {'id': 692008409, 'state': 'CANCELED', 'date': '2019-02-14T17:38:09.910336',
        ...
        'to': 'Счет 63229171188548882700'}, {'id': 431131847, 'state': 'EXECUTED', 'date': '2018-05-05T01:38:56.538074',
                                             'operationAmount': {'amount': '56071.02',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод с карты на счет',
                                             'from': 'MasterCard 9454780748494532', 'to': 'Счет 51958934737718181351'},
       ...
       {'id': 114832369, 'state': 'EXECUTED', 'date': '2019-12-07T06:17:14.634890',
        ...
        'to': 'Счет 35158586384610753655'}, {'id': 176798279, 'state': 'CANCELED', 'date': '2019-04-18T11:22:18.800453',
       ...
       {'id': 482520625, 'state': 'EXECUTED', 'date': '2019-11-13T17:38:04.800051',
        ...
        'to': 'Счет 46765464282437878125'}, {'id': 414894334, 'state': 'EXECUTED', 'date': '2019-06-30T15:11:53.136004',
       ...
       {}, {'id': 509552992, 'state': 'EXECUTED', 'date': '2019-04-19T12:02:30.129240',
            ...
            'to': 'МИР 2052809263194182'}, {'id': 596914981, 'state': 'EXECUTED', 'date': '2018-04-16T17:34:19.241289',
       ...
       {'id': 185048835, 'state': 'EXECUTED', 'date': '2019-05-06T00:17:42.736209',
        ...
        'to': 'Счет 49884962711830774470'}, {'id': 422035015, 'state': 'EXECUTED', 'date': '2019-02-27T03:59:25.921176',
                                             'operationAmount': {'amount': '69311.35',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод с карты на счет',
                                             'from': 'MasterCard 8847384717023026', 'to': 'Счет 85458008326755993377'},
       ...
       {'id': 27192367, 'state': 'CANCELED', 'date': '2018-12-24T20:16:18.819037',
        ...
        'to': 'Счет 87448526688763159781'}, {'id': 921286598, 'state': 'EXECUTED', 'date': '2018-03-09T23:57:37.537412',
       ...
       {'id': 957763565, 'state': 'EXECUTED', 'date': '2019-01-05T00:52:30.108534',
        ...
        'to': 'Счет 18889008294666828266'}, {'id': 667307132, 'state': 'EXECUTED', 'date': '2019-07-13T18:51:29.313309',
                                             'operationAmount': {'amount': '97853.86',
                                                                 'currency': {'name': 'руб.', 'code': 'RUB'}},
                                             'description': 'Перевод с карты на счет',
                                             'from': 'Maestro 1308795367077170', 'to': 'Счет 96527012349577388612'}]
# print(sorting_the_dictionary(gav))
